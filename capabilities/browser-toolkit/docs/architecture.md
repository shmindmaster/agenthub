...
| Cursor | Team Token Plan + Cursor Pro+, manual provider UI | project `.cursor/mcp.json` | Agent Skills and `.cursor/rules/*.mdc` | Offline adapter only | Native IDE | Provider hold blocks activation and testing | blocked until reauthorization |
