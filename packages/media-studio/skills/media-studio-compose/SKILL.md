...
| Concat, mux, loudness, caption burn-in, format normalize | FFmpeg via `Finish-Media.ps1` | Two-pass **linear** loudnorm `I=-16:TP=-1.5:LRA=7`. Never one-pass (that mode is dynamic pumping). Optional music duck. AAC-LC 48 kHz stereo, Fast Start. |
