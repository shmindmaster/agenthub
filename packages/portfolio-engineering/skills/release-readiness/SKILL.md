...
description: Use when a release is approaching or a repository needs a non-destructive ship or no-ship assessment backed by tests, builds, CI, blocker, and drift evidence.
...
If the executing host supports read-only test and exploration subagents, use fresh contexts for
independent checklist items. Otherwise,
