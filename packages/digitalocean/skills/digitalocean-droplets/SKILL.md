...
description: Use when a DigitalOcean Droplet or remote development box needs creation, inspection, troubleshooting, snapshots, resize, restore, networking, power, or lifecycle changes.
---
