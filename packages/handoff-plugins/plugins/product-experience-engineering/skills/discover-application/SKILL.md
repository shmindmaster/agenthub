...
Start from a bare repository and generate `_product-experience/00-discovery.md` during this task. The artifact is not a prerequisite and the user does not supply it. Follow the bootstrap rules in [artifact contracts](../../references/artifact-contracts.md).
...
7. Write and validate `_product-experience/00-discovery.md` using [artifact contracts](../../references/artifact-contracts.md).
