...
Start from the product idea, available research, and explicit constraints. No `_product-experience/` files need to exist; generate the useful experience brief, workflow design, and first-slice specification during this task. Follow [artifact contracts](../../references/artifact-contracts.md).
...
7. Write an experience brief, target workflow design, and one implementation-ready first-slice specification under `_product-experience/` using [artifact contracts](../../references/artifact-contracts.md).
