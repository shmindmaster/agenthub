...
description: Use when a Next.js application with Clerk needs middleware, Server Actions, caching, authorization, or other framework-specific authentication patterns.
license: MIT
