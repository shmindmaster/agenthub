---
name: clerk-cli
description: Use when Clerk authentication, users, organizations, sessions, deployments, instance configuration, environment keys, health, or ad-hoc API calls need command-line operation.
license: MIT
---
