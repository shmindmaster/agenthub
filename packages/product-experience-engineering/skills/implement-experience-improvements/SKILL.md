...
7. Report changed files, decisions, commands and results, and residual risks in the task response.
   Update `_product-experience/04-implementation-log.md` only when the user explicitly authorized
   persistent product-experience artifacts in this repository.
