...
7. Return the specification in the task response. If repository persistence was explicitly
   authorized, write `_product-experience/03-implementation-specification.md` and validate it with:
