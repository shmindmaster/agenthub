...
description: Use when directing how a technical beat appears on screen inside a series episode.
---

# Technical story director

Choose capture vs diagram vs animation for a **series** technical beat. You do not generate media or skip the Media Studio crew.
...
- [ ] Truth tag on the beat
- [ ] Next skill is `media-storyboard` via `media-studio`, not a slide dump
- [ ] Live UI is capture, not diffusion
