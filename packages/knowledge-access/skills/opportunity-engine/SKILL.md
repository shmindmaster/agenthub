...
description: Use when turning a JD, RFP, Upwork post, or client brief into a tailored resume, bid, proposal, rate table, or interview/discovery prep. Also for /tailor-resume, /bid, /proposal, /prep, /price, opportunity parser, portfolio match, or opportunity-response-engine.
---

# Opportunity Response Engine

Companion to `use-knowledge-access`. That skill gets at the documents.
This one turns them into something you send.
