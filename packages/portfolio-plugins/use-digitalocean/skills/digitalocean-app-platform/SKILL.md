...
description: Operate DigitalOcean App Platform apps for the SH portfolio. Use for app specs, deployments, deployment status, runtime/build logs, environment variables, bindable databases, scaling, domains attached to apps, health checks, and safe App Platform updates.
---
