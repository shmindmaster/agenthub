...
description: Inventory, audit, and operate the SH DigitalOcean portfolio. Use when asked to discover DigitalOcean apps, repos, projects, DNS zones, managed databases, Spaces buckets, inference environment variables, App Platform ownership, or account-wide operational posture.
---
