...
description: Manage and troubleshoot DigitalOcean DNS zones for the SH portfolio. Use for domain inventory, DNS records, App Platform CNAMEs, apex routing, Clerk/Microsoft mail records, DMARC/DKIM/SPF, certificate/domain failures, and DNS cutovers.
---
