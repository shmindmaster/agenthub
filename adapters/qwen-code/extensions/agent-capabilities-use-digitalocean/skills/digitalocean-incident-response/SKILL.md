...
description: Diagnose and resolve DigitalOcean incidents for SH apps. Use when an App Platform deployment fails, a service is down, health checks fail, DNS/certificates are broken, databases or Spaces are unreachable, resource usage is high, or an app needs rollback/redeploy troubleshooting.
---
