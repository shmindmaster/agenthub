...
description: Provision a DigitalOcean droplet for Codex or remote development using doctl. Use when asked to create a Codex-ready DO droplet, SSH key, remote dev box, or temporary DigitalOcean VM. For broader Droplet inventory, power actions, snapshots, rebuilds, restores, resizing, or troubleshooting, use digitalocean-droplets.
---
